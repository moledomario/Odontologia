...
const Contact = () => {
    ...
    const inputBase = 'w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:border-[var(--primary)] focus:ring-2 focus:ring-[var(--primary)] focus:ring-opacity-50 outline-none transition-all duration-300';


    return (
        <section id="contacto" className="min-h-screen bg-gray-50 pb-20 px-4">
            ...
            <div className="text-center mt-12 mb-14 max-w-2xl mx-auto">
                ...
                <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4 leading-tight" style={{ "fontFamily": "Oswald" }}>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 hover:shadow-lg transition-shadow duration-300">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 text-sm" style={{ "fontFamily": "Inter" }}>Respuesta rápida garantizada</p>
                            </div>
                        </div>
                        <p className="text-gray-500 text-sm mb-5" style={{ "fontFamily": "Inter" }}>
